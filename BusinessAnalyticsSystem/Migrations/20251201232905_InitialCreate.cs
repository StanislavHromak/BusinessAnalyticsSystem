        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FixedCosts = table.Column<double>(type: "double precision", nullable: false),
                    VariableCostPerUnit = table.Column<double>(type: "double precision", nullable: false),
                    ...
                    Investment = table.Column<double>(type: "double precision", nullable: false),
                    GrossCosts = table.Column<double>(type: "double precision", nullable: false),
                    TotalCosts = table.Column<double>(type: "double precision", nullable: false),
                    ...
                    MarginPerUnit = table.Column<double>(type: "double precision", nullable: false),
                    ROI = table.Column<double>(type: "double precision", nullable: false),
                    ROS = table.Column<double>(type: "double precision", nullable: false),
                    BreakEven = table.Column<double>(type: "double precision", nullable: false),
                    AnalysisRecommendation = table.Column<string>(type: "text", nullable: true),
                    IsGeneratedFromSales = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    SaleDateTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
